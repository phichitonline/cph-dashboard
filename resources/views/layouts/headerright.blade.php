            ...
            <div tabindex="-1" role="menu" aria-hidden="true"
                ...
                <div class="dropdown-menu-header mb-0">
                    <div class="dropdown-menu-header-inner bg-deep-blue">
                        <div class="menu-header-image opacity-1" style="background-image: url('{{ asset("images/dropdown-header/city3.jpg") }}');"></div>
                                                            ...
                                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                    <div class="avatar-icon">
                                                                        <img src="{{ asset('assets/avatars/1.jpg') }}" alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                    <div class="avatar-icon">
        ...
        <div class="widget-content p-0">
            <div class="widget-content-wrapper">
                                    ...
                                    <div class="menu-header-content text-start">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <div class="widget-heading">ผู้ใช้ทดสอบ</div>
                ...
                <div class="widget-content-left  ms-3 header-user-info">
                    <div class="widget-heading"> ผู้ใช้ทดสอบ</div>
                    <div class="widget-subheading"> เจ้าหน้าที่ทดสอบ</div>
                </div>
